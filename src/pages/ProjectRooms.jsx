...
const ProjectRooms = () => {
    ...
    try {
      ...
      setRooms([
        ...
        { 
          id: '2', 
          name: 'Defi Project', 
          description: 'Defi Project builing a decentralized finance platform for a new generation of financial services',
        ...
        { 
          ...
          description: 'Building a blockchain project for a decentralized finance platform',
  ...
  const RoomCard = ({ room }) => (
    ...
    >
      <Link 
        to={`/room/${room.id}`} 
        className={`block bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 ${
          viewMode === 'list' ? 'flex items-stretch' : 'transform hover:-translate-y-2'
        }`}
      >
        {/* Thumbnail */}
